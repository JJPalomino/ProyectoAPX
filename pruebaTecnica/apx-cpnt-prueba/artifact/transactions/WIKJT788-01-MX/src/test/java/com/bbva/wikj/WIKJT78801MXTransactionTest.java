...
/**
 * Test for transaction WIKJT78801MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT78801MXTest.xml" })
public class WIKJT78801MXTransactionTest {

	@Autowired
	private WIKJT78801MXTransaction transaction;
